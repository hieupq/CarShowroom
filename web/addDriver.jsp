...
<form id="form1" name="form1" method="post" action="do?MOD=MTN&ACT=AddDriver" >
  <table width="80%" border="0" align="center">
    ...
    <tr>
      <td><label>
        <input name="State" id="State" type="hidden" value="Miami"/>
      </label></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td><label>
        <input name="LicenseNo" id="LicenseNo" type="hidden" value="123456"/>
      </label></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td><label>
        <input name="doe"  readonly="true" type="hidden" value="2015-12-10"/>
    ...
    <tr>
      <td><label>
        <input name="Experiance" type="hidden" value="10"/>
