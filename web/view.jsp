...
<table width="90%" align="center" style="border:#D22929 solid 2px;padding:5px;" border="0" >
  ...
  <tr>
    <td><strong>Model : </strong>&nbsp;<%=(String)one.get(2)%></td>
    <td>&nbsp;</td>
    <td width="21%" rowspan="6"><img src="<%=(String)one.get(8)%>" width="220" height="120" /></td>
  </tr>
  <tr>
    <td colspan="2"><strong>Brandake</strong> : <%=(String)one.get(3)%></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<a href="javascript:bookThisVehicle(<%=(String)one.get(0)%>)">Reverse Vehicle</a></td>
    <td>&nbsp;</td>
  </tr>
</table>
<br/>
